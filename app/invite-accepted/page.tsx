...
const STATUS_CONTENT: Record<InviteStatus, { title: string; message: string }> =
  {
    success: {
      ...
      message:
        'You have successfully joined the team. You can now log in to get started.',
    },
    invalid_token: {
      title: 'Invalid Invitation',
      message:
        'This invitation link is invalid. Please contact your team administrator for a new invitation.',
    },
    cancelled: {
      title: 'Invitation Cancelled',
      message:
        'This invitation has been cancelled. Please contact your team administrator for assistance.',
    },
    already_accepted: {
    ...
    expired: {
      ...
      message:
        'This invitation link has expired. Please contact your team administrator for a new invitation.',
    },
  };
