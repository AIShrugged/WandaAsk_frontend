...
- Feature isolation: no direct imports between features (use shared/ or pass via props/context)
- Correct layer placement: UI in `ui/`, logic in `model/`, API in `api/`, hooks in `hooks/`
